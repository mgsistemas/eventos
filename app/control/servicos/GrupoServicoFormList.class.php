<?php
/**
 * GrupoServicoFormList Form List
 * @author  <your name here>
 */
class GrupoServicoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_GrupoServico');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormWrapper($this->form);
        $this->form->style = 'display: table;width:100%'; // change style
        $this->form->setFormTitle('GrupoServico');
        ...
        $container->add(TPanelGroup::pack('Grupo Fiscal', $this->form));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for GrupoServico
            $repository = new TRepository('GrupoServico');
            $limit = 10;
            // creates a criteria
            ...
            if (TSession::getValue('GrupoServico_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('GrupoServico_filter'));
            }
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $object = new GrupoServico($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new GrupoServico;  // create an empty object
            $data = $this->form->getData(); // get form data as array
            $object->fromArray( (array) $data); // load the object with data
            $object->login = TSession::getValue('login');
            $ibject->updated_at = date('Y-m-d H:i:s');
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('eventos'); // open a transaction
                $object = new GrupoServico($key); // instantiates the Active Record

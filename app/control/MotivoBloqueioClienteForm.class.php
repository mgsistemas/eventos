<?php
/**
 * MotivoBloqueioClienteForm Form
 * @author  <your name here>
 */
class MotivoBloqueioClienteForm extends TWindow
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form->addQuickAction('Confirmar', new TAction(array('ClienteList', 'onReload')), 'fa:floppy-o');

<?php
/**
 * TipoBloqueioFormList Form List
 * @author  <your name here>
 */
class TipoBloqueioFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_TipoBloqueio');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormWrapper($this->form);
        $this->form->style = 'display: table;width:100%'; // change style
        $this->form->setFormTitle('TipoBloqueio');
        ...
        $login->setValue(TSession::getValue('login'));
        ...
        $column_data_atualizacao = new TDataGridColumn('data_atualizacao', 'Data Atualização', 'left');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TipoBloqueio
            $repository = new TRepository('TipoBloqueio');
            $limit = 10;
            // creates a criteria
            ...
            if (TSession::getValue('TipoBloqueio_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('TipoBloqueio_filter'));
            }
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $object = new TipoBloqueio($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new TipoBloqueio;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('eventos'); // open a transaction
                $object = new TipoBloqueio($key); // instantiates the Active Record

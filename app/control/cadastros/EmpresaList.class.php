...
class EmpresaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $column_data_atualizacao = new TDataGridColumn('data_atualizacao', 'Data Atualizacao', 'left');
        ...
        $order_data_atualizacao = new TAction(array($this, 'onReload'));
        $order_data_atualizacao->setParameter('order', 'data_atualizacao');
        $column_data_atualizacao->setAction($order_data_atualizacao);

<?php
/**
 * GrupoTrabalhoFormList Form List
 * @author  <your name here>
 */
class GrupoTrabalhoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_GrupoTrabalho');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormWrapper($this->form);
        $this->form->style = 'display: table;width:100%'; // change style
        $this->form->setFormTitle('GrupoTrabalho');
        ...
        $this->form->addQuickField('Ordem', $ordem,  100 , new TRequiredValidator);
        $this->form->addQuickField('Situação', $situacao,  200 , new TRequiredValidator);
        ...
        $container->add(TPanelGroup::pack('Grupo de Trabalho', $this->form));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for GrupoTrabalho
            $repository = new TRepository('GrupoTrabalho');
            $limit = 10;
            // creates a criteria
            ...
            if (TSession::getValue('GrupoTrabalho_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('GrupoTrabalho_filter'));
            }
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $object = new GrupoTrabalho($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new GrupoTrabalho;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('eventos'); // open a transaction
                $object = new GrupoTrabalho($key); // instantiates the Active Record

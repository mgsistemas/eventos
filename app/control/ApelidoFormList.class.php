<?php
/**
 * ApelidoFormList Form List
 * @author  <your name here>
 */
class ApelidoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Apelido');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormWrapper($this->form);
        $this->form->style = 'display: table;width:100%'; // change style
        $this->form->setFormTitle('Apelido');
        ...
        $column_login = new TDataGridColumn('login', 'Por', 'center');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Apelido
            ...
            if (TSession::getValue('Apelido_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('Apelido_filter'));
            }
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $object = new Apelido($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Apelido;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('eventos'); // open a transaction
                $object = new Apelido($key); // instantiates the Active Record
